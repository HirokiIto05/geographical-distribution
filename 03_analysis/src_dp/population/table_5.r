main <- function() {
  ...
  openxlsx::write.xlsx(show_jap, file = here::here("04_output", "tables", "output_dp", "table_5_japan.xlsx"))
  openxlsx::write.xlsx(show_for, file = here::here("04_output", "tables", "output_dp", "table_5_foreign.xlsx"))
